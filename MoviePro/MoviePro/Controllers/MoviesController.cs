...
namespace MoviePro.Controllers
{
    ...
    public class MoviesController : Controller
    {
        ...
        /// <summary>
        /// Provide Movie data from database on "Import" page
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get all movies from database to display on "Library"
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get Movie details for single move to display on "Details"
        /// </summary>
        /// <param name="id"></param>
        ...
        /// <summary>
        /// Method for user importing new movie
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [HttpPost]
